...
a):null},loadScript:function(a,b){b=h.createElement("script");b.type="text/javascript";b.src=a;h.body.appendChild(b)}},o={parse:e.JSON&&e.JSON.parse||function(){return"string"!==typeof data||!data?null:(new Function("return "+data))()},stringify:e.JSON&&e.JSON.stringify||function(a){var b=typeof a;if("object"!==b||null===a){if("string"===b)return'"'+a+'"'}else{var d,c,e=[],f=a.constructor===Array;for(d in a)c=a[d],b=typeof c,"string"===b?c='"'+c+'"':"object"===b&&null!==c&&(c=this.stringify(c)),e.push((f?
"":'"'+d+'":')+c);return(f?"[":"{")+e.join()+(f?"]":"}")}}};return function(){var a,b,d=this,c=0,g=function(){0===c&&"function"===typeof f.arrived&&f.arrived(d)};if(e.visit&&"object"===typeof e.visit)for(a in e.visit)f[a]=e.visit[a];for(a in n)if(b=d[a]=n[a](),"function"===typeof b)try{b(function(a,b){d[b]=a;c--;g()},a),c++}catch(h){console.log(h.message)}g()}}();e.visitor=new p})(this);
